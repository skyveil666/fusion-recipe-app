...
【条件】- カテゴリー: ${category || '主菜'} - 人数: ${servings || '2人前'}${ingredients && ingredients.length > 0 ? ` - 使いたい食材: ${ingredients.join('、')}` : ''}${csClause}${ctClause}${allergyClause}`;
...
【条件】
- カテゴリー: ${category || '主菜'}
- 人数: ${servings || '2人前'}${ctClause}${allergyClause}`;
